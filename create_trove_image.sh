...
print_usage() {
    ...
    echo " -s | --datastore: name of the storage backend to use. Possible options are mysql, redis or mongodb."
...
required_params_control() {
    ...
    : ${DATASTORE:?"Name of the datastore to use required. Possible options are mysql, redis or mongodb."}
}
